...
use unapi\kontur\focus\objects\definitions\LegalAddress;
...
class RequisitesUL implements DtoInterface
{
     ...
     */
    public function getBranches(): lists\Branches
    {
        return $this->branches;
    }

    /**
     * @param lists\Branches $branches
     * @return RequisitesUL
     */
    public function setBranches(lists\Branches $branches): RequisitesUL
    {
     ...
     * @return lists\Heads
     */
    public function getHeads(): lists\Heads
    {
        return $this->heads;
    }

    /**
     * @param lists\Heads $heads
     * @return RequisitesUL
     */
    public function setHeads(lists\Heads $heads): RequisitesUL
    {
        $this->heads = $heads;
        return $this;
    }
    ...
    /**
     * @return lists\ManagementCompanies
     */
    public function getManagementCompanies(): lists\ManagementCompanies
    {
        return $this->managementCompanies;
    }

    /**
     * @param lists\ManagementCompanies $managementCompanies
     * @return RequisitesUL
     */
    public function setManagementCompanies(lists\ManagementCompanies $managementCompanies): RequisitesUL
    {
    ...
    public static function toDto(array $data): DtoInterface
    {
        ...
        if (array_key_exists('branches', $data))
            $result->setBranches(lists\Branches::toDto($data['branches']));
        ...
        if (array_key_exists('heads', $data))
            $result->setHeads(lists\Heads::toDto($data['heads']));

        if (array_key_exists('managementCompanies', $data))
            $result->setManagementCompanies(lists\ManagementCompanies::toDto($data['managementCompanies']));
